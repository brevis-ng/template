...
var MAC={
    ...
    'Copy': function(s){
        ...
        MAC.Pop.Msg(100,20,'Copy thành công',1000);
    },
    'Home': function(o,u){
        try{
            ...
            if(window.netscape){
                ...
                catch(e){ MAC.Pop.Msg(150,40,'Thao tác này đã bị trình duyệt từ chối! Vui lòng đặt thủ công',1000); }
    ...
    'Fav': function(u,s){
        try{ window.external.addFavorite(u, s);}
            ...
            try{window.sidebar.addPanel(s, u, "");}catch (e){ MAC.Pop.Msg(150,40,'Có lỗi khi thêm vào bộ sưu tập, vui lòng sử dụng bàn phím Ctrl + D để thêm',1000); }
        }
    },
    'Open': function(u,w,h){
    ...
    'Verify': {
        ...
        'Show':function(){
            return '<img class="mac_verify_img" src="'+ maccms.path +'/index.php/verify/index.html?"  title="Bạn không thể nhìn rõ? Hãy đổi một cái!">';
        }
    },
    'PageGo':{
        'Init':function() {
    ...
    'Score': {
        'Init':function(){
            ...
            MAC.Ajax(maccms.path+'/index.php/ajax/score?mid='+ $('.mac_score').attr('data-mid') +'&id=' +$('.mac_score').attr('data-id'),'post','json','',function(r){
                ...
                $(".mac_score").html('Không tải được xếp hạng');
            });
    ...
    'Gbook':{
        ...
        'Show':function($page){
            MAC.Ajax(maccms.path+'/index.php/gbook/index?page='+$page,'post','json','',function(r){
                ...
                $(".mac_gbook_box").html('Không tải được tin nhắn, vui lòng làm mới ...');
            });
        },
        'Submit':function(){
            if($(".gbook_content").val() == ''){
                MAC.Pop.Msg(100,20,'Vui lòng nhập tin nhắn của bạn!',1000);
                return false;
            }
        ...
        'Report':function(name,id){
            MAC.Pop.Show(400,251,'Lỗi dữ liệu',maccms.path+'/index.php/gbook/report.html?id='+id+'&name='+ encodeURIComponent(name),function(r){
    ...
    'History': {
        ...
        'Init':function(){
            ...
            html +='<dt><i class="fa fa-trash"></i><a target="_self" href="javascript:void(0)" onclick="MAC.History.Clear();">Làm mới</a></dt>';
    ...
    'User':{
        ...
        'Init':function(){
            ...
            if(MAC.Cookie.Get('user_id') !=undefined && MAC.Cookie.Get('user_id')!=''){
                ...
                if($('.mac_user').length >0) {
                    ...
                    html += '<ul class="logged"><li><a target="_blank" href="' + url + '">Trung tâm người dùng</a></li><li class="logout"><a class="logoutbt" href="javascript:;" onclick="MAC.User.Logout();" target="_self"><i class="user-logout"></i>từ bỏ</a></li></ul>'
        ...
        'Login':function(){
            ...
            MAC.Pop.Show(300,280,'Đăng nhập người dùng',maccms.path+'/index.php/user/'+ac,function(r){
        ...
        'BuyPopedom':function(o){
            var $that = $(o);
            if($that.attr("data-id")){
                if (confirm('Bạn có chắc chắn muốn mua phần truy cập dữ liệu này không?')) {
    ...
    'Comment':{
        ...
        'Show':function($page){
            if($(".mac_comment").length>0){
                MAC.Ajax(maccms.path + '/index.php/comment/ajax.html?rid='+$('.mac_comment').attr('data-id')+'&mid='+ $('.mac_comment').attr('data-mid') +'&page='+$page,'get','json','',function(r){
                    ...
                    $(".mac_comment").html('<a href="javascript:void(0)" onclick="MAC.Comment.Show('+$page+')">Không tải được nhận xét, hãy nhấp vào tôi để làm mới ...</a>');
                });
            }
        },
        'Reply':function($o){
        ...
        'Submit':function($o){
            ...
            if($('.mac_comment').attr('data-mid') == ''){
                MAC.Pop.Msg(100,20,'Mô-đun giữa là sai!',1000);
                return false;
            }
            if($('.mac_comment').attr('data-id') == ''){
                MAC.Pop.Msg(100,20,'Id hiệp hội bị sai!',1000);
                return false;
            }
