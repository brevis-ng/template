    ...
    $(document).ready(function(){
        ...
        if(urllin != null){
            ...
            for(var i=0;i<urldata.length;i++){
                $("#ec-xlqh").append('<button type="button" value="' + urldata[i] + '">Kênh' + (i+1) + '</button>');
            };
        };
        ...
        if(jxurllin != null){
            ...
            for(var i=0;i<urldata.length;i++){
                $("#jk").append('<option value="' + urldata [i] + '" selected="">' + (i+1) + 'Phân tích</option>');
            };
        };
        $('#ssdi').click(function(){
            var jxapi = $('#jk').val();
            ...
            if(official == -1){
                MAC.Pop.Msg(100,20,'Vui lòng kiểm tra địa chỉ',1000);
            }else{
        ...
        $("#ec-xlqh button").click(function(){
            ...
            if(official == -1){
                MAC.Pop.Msg(100,20,'Tài nguyên đám mây',1000);
            }else{
                $(this).addClass("ok").siblings().removeClass("ok");
                $("#playleft iframe").attr("src",fullurl);
                MAC.Pop.Msg(100,20,'Đã chuyển giao thành công',1000);
            };
        });
        //滚动公告
